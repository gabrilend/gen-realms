...
## Current Behavior
Context window management system for LLM calls implemented in `src/llm/06-context-manager.h/c` with 37 unit tests.
...
## Acceptance Criteria
- [x] Token counting works (5-007a)
- [x] Entries added with priorities (5-007b)
- [x] Overflow triggers summarization (5-007c)
- [x] Context builds correctly (5-007b)
- [x] Window stays within limits (5-007a, 5-007c)
